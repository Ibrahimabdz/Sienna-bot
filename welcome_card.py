...
def overlay_frame(frame: Image.Image, avatar: Image.Image, name: str, is_welcome: bool) -> Image.Image:
    ...
    if is_welcome:
        ...
        st((TX,TY+118), ">>  Accepte les regles du serveur", F(POPPINS_MED,19), (200,255,200,240))
        st((TX,TY+146), ">>  Choisis tes roles",             F(POPPINS_MED,19), (200,200,255,240))
        ...
        st((TX,TY+152), "~  On espere vous revoir bientot...", F(LORA_ITALIC,17),  (200,160,255,220))
